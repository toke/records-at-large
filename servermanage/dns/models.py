...
class Zone(models.Model):
    ...
    soa = models.CharField(max_length=255,
                           default="a.ns.myns.net
                           hostmaster.myns.net 0 10800 3600 604800 3600")
    a_record = models.CharField(max_length=255,
                                default="127.0.0.1")
    mx_record = models.CharField(max_length=255, default="a.mx.mymx.net")
    mx_prio = models.CharField(max_length=255, default="10")
    ns1_record = models.CharField(max_length=255,
                                  default="a.ns.myns.net")
    ns2_record = models.CharField(max_length=255,
                                  default="b.ns.myns.net")
...
#      unique_together = (("type", "name"),)      
  ...
  def update_dyn(name, ip):
    """Update der DynIP-Zone"""
    try:
      name = name + '.dyn.kerpe.net'
